 ...
 * Description:
 */
class NewMainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    private Button scan;
    ...
    public void cameraTask() {
        if (EasyPermissions.hasPermissions(this, android.Manifest.permission.CAMERA)) {
            ...
            Log.i("444", "有相机");
            startActivity(new Intent(NewMainActivity.this, CaptureActivity.class));
        } else {
            Log.i("444", "无相机");
            // 禁止过（没设以后都禁止）
